...
public class UserActivity {
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		else if(user.getUserRole() == UserRole.MODERATOR && (question.getUser()==user || question.getUser().getUserRole()==UserRole.USER)){
			questionService.deleteQuestion(question);
		}// Else if condition to check if the user is a regular use
		else if(user.getUserRole() == UserRole.USER && question.getUser()==user){
			questionService.deleteQuestion(question);
		}
		else{
